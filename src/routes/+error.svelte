<svelte:head>
	<title>𝚜𝚞𝚔𝚒</title>
	<meta name="description" content="suki's website" />
</svelte:head>

<div class="error" data-value="LOST.">LOST.</div>
...
<style>
	...
	.error::before {
		...
		animation:  before-action 3s infinite linear alternate-reverse;
	}
	...
	.error::after {
		...
		animation: after-action 3s infinite linear alternate-reverse;
	}

	@keyframes before-action {
		0% {
